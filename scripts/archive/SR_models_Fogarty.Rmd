...
The results of the analysis using the standard deviation of the recruitment residuals from the Ricker Stock Recruitment models and the GAM models both indicated that recruitment variability was larger for Haddock than for Atlantic Cod (Table 2). The standard deviation of the recruitment residuals were on average `r ratio.pre`% higher (Ricker model residuals) for the Haddock Stocks in the *Pre 1993* period than the Atlantic Cod stocks (Figure \@ref(fig:sd-resid-sr), and Table 2). In the *Recent* Period, the standard deviation of the recruitment residuals were on average `r ratio.recent`% higher (Ricker model residuals) for the Haddock Stocks than the Atlantic Cod stocks (Figure \@ref(fig:sd-resid-sr) and Table 2), similar to the *Pre 1993* period. 
