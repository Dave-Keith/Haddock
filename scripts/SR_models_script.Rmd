...
p.ssb.ts
save_plot("D:/Github/Haddock/Results/Figure_1.png",p.ssb.ts,base_height = 8,base_width = 11,dpi=600)
```
...
p.rec.ts
save_plot("D:/Github/Haddock/Results/Figure_2.png",p.rec.ts,base_height = 8,base_width = 11,dpi=600)
...
p.rssb.ts
save_plot("D:/Github/Haddock/Results/Figure_3.png",p.rssb.ts,base_height = 8,base_width = 11,dpi=600)
...
p.ccf.split <- ggplot(dat.ccf.split,aes(y=Correlation,x=Location,fill = Location,shape = Location,color=Location,group = Period)) + 
                  ...
                  theme(axis.text.x = element_text(angle = 45, hjust = 1.,size=16), 
                        ...
                        #legend.title = element_blank(),legend.position = 'top') + xlab("")

p.ccf.split
save_plot("D:/Github/Haddock/Results/Figure_4.png",p.ccf.split,base_height = 10, base_width = 14,dpi=600)
#save_plot("D:/Github/Haddock/Results/Figure_4_with_legend.png",p.ccf.split,base_height = 10, base_width = 14,dpi=600)
...
p.sds.combo
save_plot("D:/Github/Haddock/Results/Figure_5.png",p.sds.combo,base_height = 8,base_width =11,dpi=600)
...
save_plot("D:/Github/Haddock/Results/Figure_S4.png",p.acf.split.sr,base_height = 10,base_width = 20,dpi=600)
...
save_plot("D:/Github/Haddock/Results/Figure_6.png",alpha.plt,base_height = 8,base_width = 11,dpi=600)
...
diff.alpha$Location[is.na(diff.alpha$Location)] <- "Irish Sea"
...
save_plot("D:/Github/Haddock/Results/Figure_7.png",diff.plt,base_height = 11,base_width =11,dpi=600)
...
save_plot("D:/Github/Haddock/Results/Figure_S2.png",p.freq,base_height = 9,base_width = 12,dpi=600)
...
save_plot("D:/Github/Haddock/Results/Figure_S5.png",p.acf.split.gam,base_height = 10,base_width = 20,dpi=600)
...
sr.pd.resid.plt
save_plot(plot = sr.pd.resid.plt,filename = "D:/Github/Haddock/Results/Figure_S3.png",base_height = 8.5,base_width =11,dpi=600)
...
p.sds.combo.app
save_plot("D:/Github/Haddock/Results/Figure_S6.png",p.sds.combo.app,base_height = 8,base_width =11,dpi=600)
```
...
save_plot("D:/Github/Haddock/Results/Figure_S7.png",alpha.plt,base_height = 8,base_width = 8,dpi=600)
